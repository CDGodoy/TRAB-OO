...
public class MassScreen extends JFrame {
		...
		public MassScreen() {
			...
			comboBoxO.setModel(new DefaultComboBoxModel(new String[] {"mg - Miligramas", "cg - Centigramas", "dg - Decigramas", "g - Gramas", "dag - Decagramas", "hg - Hectogramas", "kg - Quilogramas"}));
			...
			comboBoxD.setModel(new DefaultComboBoxModel(new String[] {"mg - Miligramas", "cg - Centigramas", "dg - Decigramas", "g - Gramas", "dag - Decagramas", "hg - Hectogramas", "kg - Quilogramas"}));
